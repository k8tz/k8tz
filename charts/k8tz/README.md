...
| webhook.certManager.secretTemplate | Add custom labels and annotations to `Secret` that containing certificate generated by cert-manager. Please refer to cert-manager documentation for using this                | {}                |
| webhook.certManager.duration       | The duration for the `Not After` date for the certificate generated by cert-manager. Please refer to cert-manager documentation for using this                                | 5114d             |
| webhook.certManager.renewBefore    | How long before the currently issued certificate’s expiry cert-manager should renew the certificate. Please refer to cert-manager documentation for using this                | {}                |
| webhook.certManager.issuerRef      | Reference to cert-manager issuer deployed on the cluster. Please refer to cert-manager documentation for using this                                                           | name: selfsigned <br>kind: Issuer |
